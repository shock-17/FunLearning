...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const updateKidScore = (
    ...
    const activeProfileIndex = user.kidProfiles.findIndex(
    ...
    const updatedActiveProfile = JSON.parse(
      JSON.stringify(updatedProfiles[activeProfileIndex]),
    )
